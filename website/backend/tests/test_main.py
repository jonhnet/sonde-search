...
class Test_v2:
    ...
    def test_unsubscribe_without_cookies(self, server):
        ...
        post(
            ...
            cookies={"notifier_user_token_v2": "foo"},
        )
        resp4 = get("get_config", cookies={"notifier_user_token_v2": user_token}).json()
    ...
    def test_oneclick_unsubscribe(self):
        ...
        resp4 = post("oneclick_unsubscribe", data={"uuid": resp1["subs"][0]["uuid"]}).json()
    ...
    def test_get_sonde_listeners_success(self, mock_requests, mock_sondehub):
        ...
        test_data = [
            ...
            },
            {
                "uploader_callsign": "KB1LQD",
                "frame": 101,
                "datetime": "2023-01-01T12:00:01Z",
                "alt": 1010,
                "vel_v": 5.1,
            },
            {
                "uploader_callsign": "KK6HMI-2",
                "frame": 100,
                "datetime": "2023-01-01T12:00:00Z",
                "alt": 1000,
                "vel_v": 5.0,
    ...
    def test_lib_listeners_function(self, mock_sondehub):
        ...
        test_data = [
            ...
            },
            {
                "uploader_callsign": "LISTENER1",
                "frame": 1001,
                "datetime": "2023-01-01T10:00:01Z",
                "alt": 5100,
                "vel_v": 10.5,
            },
            {
                "uploader_callsign": "LISTENER2",
                "frame": 1000,
                "datetime": "2023-01-01T10:00:00Z",
                "alt": 5000,
                "vel_v": 10.0,
    ...
    def test_generate_landing_calendar_invalid_params(self, server):
        ...
        resp = requests.get(
            "http://127.0.0.1:8080/generate_landing_calendar",
            params={
                "bottom_lat": "47.0",
...
class Test_EmailNotifier:
    ...
    def get_body(self, sent_email: RawMessage) -> str:
        ...
        body = base64.b64decode(email_obj.get_payload()[0].get_payload()[0].get_payload()).decode(
            "utf8"
        )
        return body
